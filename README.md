...
| Import Guard | Validates imported data, quarantines invalid entries, and creates a pre-import backup before storage writes |
...
| `style-data.js` | Shared import schema guard, quarantine, merge/replace summary, and pre-import backup helpers |
