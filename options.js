...
(async function(){
  ...
  function syncSettingsControls() {
    ...
    $('set-block-remote').checked = settings.blockRemoteCss === true;
  ...
  $('save-settings').addEventListener('click',async()=>{
    ...
    settings.blockRemoteCss=$('set-block-remote').checked;
